...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        MainClientWindow.resize(809, 609)
        ...
        self.list_contacts.setGeometry(QtCore.QRect(10, 90, 181, 411))
        self.list_contacts.setObjectName("list_contacts")
        self.list_messages = QtWidgets.QListView(self.centralwidget)
        self.list_messages.setGeometry(QtCore.QRect(290, 90, 441, 321))
        self.list_messages.setObjectName("list_messages")
        self.btn_send = QtWidgets.QPushButton(self.centralwidget)
        self.btn_send.setGeometry(QtCore.QRect(610, 520, 131, 31))
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(290, 520, 131, 31))
        self.btn_clear.setObjectName("btn_clear")
        self.text_message_2 = QtWidgets.QTextEdit(self.centralwidget)
        self.text_message_2.setGeometry(QtCore.QRect(10, 30, 441, 31))
        self.text_message_2.setObjectName("text_message_2")
        self.find_contacts = QtWidgets.QLabel(self.centralwidget)
        self.find_contacts.setGeometry(QtCore.QRect(10, 0, 101, 16))
        self.find_contacts.setObjectName("find_contacts")
        self.btn_add_contact_2 = QtWidgets.QPushButton(self.centralwidget)
        self.btn_add_contact_2.setGeometry(QtCore.QRect(470, 30, 121, 31))
        self.btn_add_contact_2.setObjectName("btn_add_contact_2")
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        self.find_contacts.setText(_translate("MainClientWindow", "Поиск контактов:"))
        self.btn_add_contact_2.setText(_translate("MainClientWindow", "Добавить"))
